...
## Pinned requirements with nox-poetry
...
These files can in turn be used as [constraints files][pip-constraints-files],
...
Import `nox_poetry.patch` in `noxfile.py`:
...
nox > poetry export --format=requirements.txt --output=.nox/tests-3-9/tmp/requirements.txt --dev
nox > pip install --constraint=.nox/tests-3-9/tmp/requirements.txt pytest coverage[toml] file://.../hypermodern-python/dist/hypermodern_python-0.1.0-py3-none-any.whl#sha256=8c452f404aaeb57819ea4f66a64fc5b9e55502940d764b7ff4c3b228f542441b
...
nox > pip install --constraint=.nox/coverage/tmp/requirements.txt coverage[toml]
